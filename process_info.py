...
def is_connected():
    try:
        ...
        urllib.urlopen("http://www.gmail.com",timeout = 1)
        return True
    except urllib.URLError :
        return False
def mailsender(filename,time):
  try:
     fromaddr = "vaibhavmisal007@gmail.com"
     toaddr = "vaibhav.instron@gmail.com"
     msg = MIMEMultipart()
     msg['from'] =fromaddr
     msg['to'] = toaddr
     body = """
     ...
     msg1.set_payload( (attachment).read() )
     encoders.encode_base64(msg1)
     msg1.add_header('content-Disposition', "attachment; filename = %s" %filename)
     msg.attach( msg1 )
     s = smtplib.SMTP('smtp.gmail.com',587)
     s.starttls()
     s.login(fromaddr,'vaibhav@7040')
     text= msg.as_string()
